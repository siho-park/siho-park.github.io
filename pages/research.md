...
| ![My graph](images/cancer_stomach.png) <br> *Stomach screening rate in South Korea* | [**Manuscript**]({% link /papers/biennial_paper_original.pdf %})  &#x7c;  [**Slides**]({% link /slides/Biannual_health_screening.pdf %}) |
|---|---|
